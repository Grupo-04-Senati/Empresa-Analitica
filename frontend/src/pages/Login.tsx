          ...
          <div>
            <div className="flex items-center gap-3 mb-16">
              ...
              <div>
                ...
                <span className="text-[11px] font-semibold tracking-[0.2em] text-blue-400 uppercase">Analitica & Desarrollo</span>
              </div>
            </div>
        ...
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div>
              ...
              <span className="text-[10px] font-semibold tracking-[0.2em] text-blue-500 uppercase">Analitica & Desarrollo</span>
            </div>
          </div>
